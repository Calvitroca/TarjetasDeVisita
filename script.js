$(document).ready(function () {
    ...
    const registrarVisita = (telefono, bebida, visitasPrevias) => {
      return $.ajax({
        ...
        .done((response) => {
          ...
          // Actualizar contenido del ticket (corrección para evitar redundancias)
          ...
          $("#ticket-agradecimiento").text("¡Gracias por tu visita!");
  
          // Mostrar ticket y botón de imprimir
          $("#ticket").removeClass("hidden");
          $("#imprimir-ticket").removeClass("hidden");
    ...
    $("#verificar-telefono").on("click", function () {
      ...
      verificarUsuario(telefono)
        .done(function (usuario) {
          console.log("Respuesta de consultarEstado:", usuario);
    ...
    $("#registrar-usuario").on("click", function () {
      ...
      registrarUsuario(telefono, nombre, bebida)
        .done(function () {
          $("#resultado")
            .text(
              `¡Bienvenido ${nombre}! Tu tarjeta de ${bebida} está activa.`
            )
            .removeClass("hidden alert-danger")
            .addClass("alert-success");
    ...
    $("#regresar").on("click", function () {
      ...
      $("#opciones-tarjeta").addClass("hidden"); // Ocultar opciones al regresar
    });
  });